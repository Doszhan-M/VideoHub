...
if (process.env.NODE_ENV == 'production') {
    ...
    loginUrlRedirectVideoUpload = 'https://dev-ge0s31km.us.auth0.com/authorize?response_type=code&client_id=4ap6Vuy6rEcpNAkzQ2IMzFTcThpWKqTN&redirect_uri=https://doszhan.online/api/web/accounts/authO/login/&scope=openid%20profile%20email&state=https://doszhan.online/video_edit'
    websocketUrl = 'wss://doszhan.online'
} else {
    ...
    websocketUrl = 'wss://video.localhost'
}

export { loginUrl, logoutUrl, loginUrlRedirectVideoUpload, websocketUrl }
