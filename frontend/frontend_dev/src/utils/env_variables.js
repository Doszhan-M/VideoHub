...
if (process.env.NODE_ENV == 'production') {
    ...
    loginUrlRedirectVideoEdit = 'https://dev-ge0s31km.us.auth0.com/authorize?response_type=code&client_id=4ap6Vuy6rEcpNAkzQ2IMzFTcThpWKqTN&redirect_uri=https://video.localhost/api/web/accounts/authO/login/&scope=openid%20profile%20email&state=https://video.localhost/video_edit'
}

export {loginUrl, logoutUrl, loginUrlRedirectVideoEdit}
