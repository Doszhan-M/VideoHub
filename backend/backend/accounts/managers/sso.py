...
class SsoManager():
    ...
    def get_sso_config(self) -> dict:
        ...
        sso_config_url = 'https://dev-ge0s31km.us.auth0.com/.idp/.well-known/openid-configuration'
    ...
    def sso_data_request(self) -> str:
        ...
        response = request("POST", self.sso_token_endpoint,
    ...
    def get_session_id(request) -> dict:
        try:
            data = {'session_id': request.COOKIES['sessionid'],
